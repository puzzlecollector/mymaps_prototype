package com.mkim14.mymaps_cs194a
...
import com.mkim14.mymaps_cs194a.models.Place
import com.mkim14.mymaps_cs194a.models.UserMap
...
class CreateMapActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mapFragment.view?.let{
            Snackbar.make(it, "Long press to add a marker", Snackbar.LENGTH_INDEFINITE).setAction("OK",{}).setAction("OK",{}).setActionTextColor(
                ContextCompat.getColor(this,android.R.color.white)).show()
        }
    }
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        if (item.itemId == R.id.miSave){
            ...
            val mapTitle = intent.getStringExtra(EXTRA_MAP_TITLE) as String
